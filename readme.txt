...
1. The inputs folder contains contains NIRIS Stokes profiles samples from BBSO/GST.
2. The Outputs folder contains contains inverted results, bx, by, bz, Doppler width and LOS velocity.
